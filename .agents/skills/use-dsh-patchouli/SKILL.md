...
Use the current [repository](https://github.com/memorax-ai/dsh-patchouli), [protocol](https://github.com/memorax-ai/dsh-patchouli/tree/main/packages/protocol), and repository configuration as the authority for details.
