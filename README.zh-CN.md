...
- 在消费端完成聚合，保留各知识插件的原生结果，并可选用独立模型筛选证据。
...
安装、接入 DSH、开发 MemoryPlugin、扩展存储或后端，以及排查问题前，请先加载 [`use-dsh-patchouli`](https://github.com/memorax-ai/dsh-patchouli/blob/main/.agents/skills/use-dsh-patchouli/SKILL.md)。
